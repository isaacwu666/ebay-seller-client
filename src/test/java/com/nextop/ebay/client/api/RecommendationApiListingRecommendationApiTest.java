...
/**
 * API tests for RecommendationApiListingRecommendationApi
 */
@Ignore
public class RecommendationApiListingRecommendationApiTest {

    private final RecommendationApiListingRecommendationApi api = new RecommendationApiListingRecommendationApi();
    ...
    public void findListingRecommendationsTest() throws ApiException {
        ...
        Object response = api.findListingRecommendations(X_EBAY_C_MARKETPLACE_ID, filter, limit, offset, findListingRecommendationRequest);
