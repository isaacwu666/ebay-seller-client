...
/**
 * API tests for FulfillmentApiPaymentDisputeApi
 */
@Ignore
public class FulfillmentApiPaymentDisputeApiTest {

    private final FulfillmentApiPaymentDisputeApi api = new FulfillmentApiPaymentDisputeApi();
    ...
    public void acceptPaymentDisputeTest() throws ApiException {
        ...
        Object response = api.acceptPaymentDispute(paymentDisputeId, acceptPaymentDisputeRequest);
    ...
    public void contestPaymentDisputeTest() throws ApiException {
        ...
        Object response = api.contestPaymentDispute(paymentDisputeId, contestPaymentDisputeRequest);
    ...
    public void fetchEvidenceContentTest() throws ApiException {
        ...
        String fileId = null;
        Object response = api.fetchEvidenceContent(paymentDisputeId, evidenceId, fileId);
    ...
    public void updateEvidenceTest() throws ApiException {
        ...
        Object response = api.updateEvidence(paymentDisputeId, updateEvidencePaymentDisputeRequest);
