...
/**
 * API tests for FeedApiOrderTaskApi
 */
@Ignore
public class FeedApiOrderTaskApiTest {

    private final FeedApiOrderTaskApi api = new FeedApiOrderTaskApi();
    ...
    public void createOrderTaskTest() throws ApiException {
        ...
        Object response = api.createOrderTask(X_EBAY_C_MARKETPLACE_ID, createOrderTaskRequest);
