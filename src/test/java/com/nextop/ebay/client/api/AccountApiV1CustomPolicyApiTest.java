...
/**
 * API tests for AccountApiV1CustomPolicyApi
 */
@Ignore
public class AccountApiV1CustomPolicyApiTest {

    private final AccountApiV1CustomPolicyApi api = new AccountApiV1CustomPolicyApi();
    ...
    public void updateCustomPolicyTest() throws ApiException {
        ...
        Object response = api.updateCustomPolicy(customPolicyId, X_EBAY_C_MARKETPLACE_ID, customPolicyRequest);
