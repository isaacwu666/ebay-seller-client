...
/**
 * API tests for FeedApiTaskApi
 */
@Ignore
public class FeedApiTaskApiTest {

    private final FeedApiTaskApi api = new FeedApiTaskApi();
    ...
    public void createTaskTest() throws ApiException {
        ...
        Object response = api.createTask(X_EBAY_C_MARKETPLACE_ID, createTaskRequest);
