...
/**
 * API tests for ComplianceApiListingViolationApi
 */
@Ignore
public class ComplianceApiListingViolationApiTest {

    private final ComplianceApiListingViolationApi api = new ComplianceApiListingViolationApi();
    ...
    public void getListingViolationsTest() throws ApiException {
        ...
        String limit = null;
        String filter = null;
        Object response = api.getListingViolations(X_EBAY_C_MARKETPLACE_ID, complianceType, offset, listingId, limit, filter);
    ...
    public void suppressViolationTest() throws ApiException {
        ...
        Object response = api.suppressViolation(suppressViolationRequest);
