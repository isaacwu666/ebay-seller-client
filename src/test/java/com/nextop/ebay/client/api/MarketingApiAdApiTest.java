...
/**
 * API tests for MarketingApiAdApi
 */
@Ignore
public class MarketingApiAdApiTest {

    private final MarketingApiAdApi api = new MarketingApiAdApi();
    ...
    public void deleteAdTest() throws ApiException {
        String adId = null;
        String campaignId = null;
        Object response = api.deleteAd(adId, campaignId);
    ...
    public void updateBidTest() throws ApiException {
        ...
        Object response = api.updateBid(adId, campaignId, updateBidPercentageRequest);
