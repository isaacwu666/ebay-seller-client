...
/**
 * API tests for MarketingApiItemPriceMarkdownApi
 */
@Ignore
public class MarketingApiItemPriceMarkdownApiTest {

    private final MarketingApiItemPriceMarkdownApi api = new MarketingApiItemPriceMarkdownApi();
    ...
    public void deleteItemPriceMarkdownPromotionTest() throws ApiException {
        ...
        Object response = api.deleteItemPriceMarkdownPromotion(promotionId);
