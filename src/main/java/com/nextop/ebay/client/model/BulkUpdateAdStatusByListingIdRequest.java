...
import com.nextop.ebay.client.model.UpdateAdStatusByListingIdRequest;
 ...
 */
@ApiModel(description = "A type that defines the fields for the <b>BulkUpdateAdStatusByListingId</b> request.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-09-07T14:51:10.412+08:00[Asia/Shanghai]")
public class BulkUpdateAdStatusByListingIdRequest implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String SERIALIZED_NAME_REQUESTS = "requests";
  @SerializedName(SERIALIZED_NAME_REQUESTS)
  private List<UpdateAdStatusByListingIdRequest> requests = null;
  ...
  public BulkUpdateAdStatusByListingIdRequest addRequestsItem(UpdateAdStatusByListingIdRequest requestsItem) {
    if (this.requests == null) {
      this.requests = new ArrayList<UpdateAdStatusByListingIdRequest>();
    }
