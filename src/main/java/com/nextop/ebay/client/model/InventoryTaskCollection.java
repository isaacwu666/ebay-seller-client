...
public class InventoryTaskCollection implements Serializable {
  ...
  private List<InventoryTask> tasks = null;
  ...
  public InventoryTaskCollection href(String href) {
  ...
  **/
  ...
  public InventoryTaskCollection limit(Integer limit) {
  ...
  **/
  ...
  public InventoryTaskCollection next(String next) {
  ...
  **/
  ...
  public InventoryTaskCollection offset(Integer offset) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of results skipped in the result set before listing the first returned result. This value can be specified in the request with the <strong>offset</strong> query parameter.<br /><br /><span class=\"tablenote\"><strong>Note:</strong> The items in a paginated result set use a zero-based list, where the first item in the list has an offset of <code>0</code>.</span>")
  ...
  public InventoryTaskCollection prev(String prev) {
  ...
  **/
  ...
  public InventoryTaskCollection tasks(List<InventoryTask> tasks) {
    
    this.tasks = tasks;
    return this;
  }

  public InventoryTaskCollection addTasksItem(InventoryTask tasksItem) {
    if (this.tasks == null) {
      this.tasks = new ArrayList<InventoryTask>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @Valid
  @ApiModelProperty(value = "An array of the inventory tasks on this page. The tasks are sorted by creation date.<br /><br /><span class=\"tablenote\"><strong>Note:</strong> An empty array is returned if the filter criteria excludes all tasks.</span>")

  public List<InventoryTask> getTasks() {
    return tasks;
  }


  public void setTasks(List<InventoryTask> tasks) {
    this.tasks = tasks;
  }


  public InventoryTaskCollection total(Integer total) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The total number of inventory tasks that match the input criteria.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InventoryTaskCollection inventoryTaskCollection = (InventoryTaskCollection) o;
    return Objects.equals(this.href, inventoryTaskCollection.href) &&
        Objects.equals(this.limit, inventoryTaskCollection.limit) &&
        Objects.equals(this.next, inventoryTaskCollection.next) &&
        Objects.equals(this.offset, inventoryTaskCollection.offset) &&
        Objects.equals(this.prev, inventoryTaskCollection.prev) &&
        Objects.equals(this.tasks, inventoryTaskCollection.tasks) &&
        Objects.equals(this.total, inventoryTaskCollection.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class InventoryTaskCollection {\n");
