 ...
 */
@ApiModel(description = "This type is used by the base response of the <strong>getPaymentDispute</strong> method. The <strong>getPaymentDispute</strong> method retrieves detailed information on a specific payment dispute.")
...
public class PaymentDispute implements Serializable {
  ...
  **/
  ...
  public PaymentDispute addAvailableChoicesItem(String availableChoicesItem) {
    if (this.availableChoices == null) {
      this.availableChoices = new ArrayList<String>();
    }
  ...
  **/
  ...
  public PaymentDispute addEvidenceRequestsItem(EvidenceRequest evidenceRequestsItem) {
    if (this.evidenceRequests == null) {
      this.evidenceRequests = new ArrayList<EvidenceRequest>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @Valid
  @ApiModelProperty(value = "This array is used to identify one or more order line items associated with the payment dispute. There will always be at least one <b>itemId</b>/<b>lineItemId</b> pair returned in this array.")
  ...
  public PaymentDispute addMonetaryTransactionsItem(MonetaryTransaction monetaryTransactionsItem) {
    if (this.monetaryTransactions == null) {
      this.monetaryTransactions = new ArrayList<MonetaryTransaction>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This is the unique identifier of the payment dispute. This is the same identifier that is passed in to the call URI. This identifier is automatically created by eBay once the payment dispute comes into the eBay system.")
