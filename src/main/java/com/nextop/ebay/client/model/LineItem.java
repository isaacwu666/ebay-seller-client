...
public class LineItem implements Serializable {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The eBay-generated legacy listing item ID of the listing. Note that the unique identifier of a listing in REST-based APIs is called the <strong>listingId</strong> instead.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of units of the line item in the order. These are represented as a group by a single <b>lineItemId</b>.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The eBay listing type of the line item. The most common listing types are <code>AUCTION</code> and <code>FIXED_PRICE</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/fulfillment/types/sel:SoldFormatEnum'>eBay API documentation</a>")
