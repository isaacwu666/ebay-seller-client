 ...
 */
@ApiModel(description = "This type contains the specifications for the entire collection of shipping fulfillments that are associated with the order specified by a <b>getShippingFulfillments</b> call. The <b>fulfillments</b> container returns an array of all the fulfillments in the collection.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-09-07T14:51:10.412+08:00[Asia/Shanghai]")
public class ShippingFulfillmentPagedCollection implements Serializable {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The total number of fulfillments in the specified order.<br /><br /><span class=\"tablenote\"><strong>Note:</strong> If no fulfillments are found for the order, this field is returned with a value of <code>0</code>.</span>")
