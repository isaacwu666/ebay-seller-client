...
import com.nextop.ebay.client.model.PromotionDetail;
 ...
 */
@ApiModel(description = "This type defines the fields in a paginated result set of seller promotions. The response consists of 0 or more sequenced pages that are returned from the complete <i>result set</i>, where each page consists of 0 or more items.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-09-07T14:51:10.412+08:00[Asia/Shanghai]")
public class PromotionsPagedCollection implements Serializable {
  ...
  private List<PromotionDetail> promotions = null;
  ...
  **/
  ...
  public PromotionsPagedCollection addPromotionsItem(PromotionDetail promotionsItem) {
    if (this.promotions == null) {
      this.promotions = new ArrayList<PromotionDetail>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @Valid
  @ApiModelProperty(value = "A list containing the details of each returned promotion. This includes all the information about the promotions except for the listings that are part of the promotions.")
