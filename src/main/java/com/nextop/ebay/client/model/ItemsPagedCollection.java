...
import com.nextop.ebay.client.model.ListingDetail;
 ...
 */
@ApiModel(description = "This type defines the fields for a paginated result set of promotions. The response consists of 0 or more sequenced pages that are returned from the complete <i>result set</i>, where each page consists of 0 or more items.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-09-07T14:51:10.412+08:00[Asia/Shanghai]")
public class ItemsPagedCollection implements Serializable {
  ...
  private List<ListingDetail> listings = null;
  ...
  **/
  ...
  public ItemsPagedCollection addListingsItem(ListingDetail listingsItem) {
    if (this.listings == null) {
      this.listings = new ArrayList<ListingDetail>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @Valid
  @ApiModelProperty(value = "An array of the listings associated with a promotion.")
  ...
  **/
  @javax.annotation.Nullable
  @Valid
  @ApiModelProperty(value = "A list of warnings that were generated by the request. Warning do not stop processing, but should be checked to ensure that the response contains the correct information.")
