 ...
 */
@ApiModel(description = "A unique ID for a sales tax jurisdiction.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-09-07T14:51:10.412+08:00[Asia/Shanghai]")
public class SalesTaxJurisdiction implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(value = "The unique ID for a sales tax jurisdiction.")
