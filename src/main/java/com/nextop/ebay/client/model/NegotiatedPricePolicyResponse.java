...
import com.nextop.ebay.client.model.NegotiatedPricePolicy;
...
public class NegotiatedPricePolicyResponse implements Serializable {
  ...
  private List<NegotiatedPricePolicy> negotiatedPricePolicies = null;
  ...
  public NegotiatedPricePolicyResponse addNegotiatedPricePoliciesItem(NegotiatedPricePolicy negotiatedPricePoliciesItem) {
    if (this.negotiatedPricePolicies == null) {
      this.negotiatedPricePolicies = new ArrayList<NegotiatedPricePolicy>();
    }
  ...
  **/
  ...
  @Valid
  @ApiModelProperty(value = "A list of category IDs and the policies related to negotiated-price items for each of the listed categories.")
