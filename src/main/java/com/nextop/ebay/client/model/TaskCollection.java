 ...
 */
@ApiModel(description = "The type that defines the fields for a paginated result set of tasks. The response consists of 0 or more sequenced <em> pages</em> where each page has 0 or more items.")
...
public class TaskCollection implements Serializable {
  ...
  **/
  @javax.annotation.Nullable
  @Valid
  @ApiModelProperty(value = "An array of the tasks on this page. The tasks are sorted by creation date. An empty array is returned if the filter criteria excludes all tasks. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The total number of tasks that match the input criteria.")
