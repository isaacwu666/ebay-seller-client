...
public class FeedApiInventoryTaskApi {
    private ApiClient localVarApiClient;

    public FeedApiInventoryTaskApi() {
        this(Configuration.getDefaultApiClient());
    }

    public FeedApiInventoryTaskApi(ApiClient apiClient) {
     ...
     * @param createInventoryTaskRequest  (optional)
     ...
     */
    public okhttp3.Call createInventoryTaskCall(String X_EBAY_C_MARKETPLACE_ID, CreateInventoryTaskRequest createInventoryTaskRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createInventoryTaskValidateBeforeCall(String X_EBAY_C_MARKETPLACE_ID, CreateInventoryTaskRequest createInventoryTaskRequest, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = createInventoryTaskCall(X_EBAY_C_MARKETPLACE_ID, createInventoryTaskRequest, _callback);
        return localVarCall;
     ...
     */
    public Object createInventoryTask(String X_EBAY_C_MARKETPLACE_ID, CreateInventoryTaskRequest createInventoryTaskRequest) throws ApiException {
        ApiResponse<Object> localVarResp = createInventoryTaskWithHttpInfo(X_EBAY_C_MARKETPLACE_ID, createInventoryTaskRequest);
     ...
     */
    public ApiResponse<Object> createInventoryTaskWithHttpInfo( String X_EBAY_C_MARKETPLACE_ID,  CreateInventoryTaskRequest createInventoryTaskRequest) throws ApiException {
        okhttp3.Call localVarCall = createInventoryTaskValidateBeforeCall(X_EBAY_C_MARKETPLACE_ID, createInventoryTaskRequest, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /inventory_task (asynchronously)
     * This method creates an inventory-related download task for a specified feed type with optional filter criteria. When using this method, specify the &lt;strong&gt;feedType&lt;/strong&gt;. &lt;br/&gt;&lt;br/&gt;This method returns the location response header containing the &lt;strong&gt;getInventoryTask&lt;/strong&gt; call URI to retrieve the inventory task you just created. The URL includes the eBay-assigned task ID, which you can use to reference the inventory task.&lt;br/&gt;&lt;br/&gt;To retrieve the status of the task, use the &lt;strong&gt;getInventoryTask&lt;/strong&gt; method to retrieve a single task ID or the &lt;strong&gt;getInventoryTasks&lt;/strong&gt; method to retrieve multiple task IDs.&lt;p&gt; &lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;strong&gt;Note:&lt;/strong&gt; The scope depends on the feed type. An error message results when an unsupported scope or feed type is specified.&lt;/span&gt;&lt;/p&gt;Presently, this method supports Active Inventory Report. The &lt;strong&gt;ActiveInventoryReport&lt;/strong&gt; returns a report that contains price and quantity information for all of the active listings for a specific seller. A seller can use this information to maintain their inventory on eBay.
     * @param X_EBAY_C_MARKETPLACE_ID The ID of the eBay marketplace where the item is hosted. &lt;p&gt; &lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;strong&gt;Note:&lt;/strong&gt; This value is case sensitive.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;For example:&lt;/p&gt;&lt;p&gt;&lt;code&gt;X-EBAY-C-MARKETPLACE-ID:EBAY_US&lt;/code&gt;&lt;/p&gt;&lt;p&gt;This identifies the eBay marketplace that applies to this task. See &lt;a href&#x3D;\&quot;/api-docs/sell/feed/types/bas:MarketplaceIdEnum\&quot;&gt;MarketplaceIdEnum&lt;/a&gt;.&lt;/p&gt; (optional)
     * @param createInventoryTaskRequest  (optional)
     ...
     */
    public okhttp3.Call createInventoryTaskAsync(String X_EBAY_C_MARKETPLACE_ID, CreateInventoryTaskRequest createInventoryTaskRequest, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = createInventoryTaskValidateBeforeCall(X_EBAY_C_MARKETPLACE_ID, createInventoryTaskRequest, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
    ...
    private okhttp3.Call getInventoryTaskValidateBeforeCall(String taskId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getInventoryTaskCall(taskId, _callback);
        return localVarCall;
     ...
     */
    public ApiResponse<InventoryTask> getInventoryTaskWithHttpInfo( @NotNull String taskId) throws ApiException {
    ...
    /**
     * /inventory_task/{task_id} (asynchronously)
     * This method retrieves the task details and status of the specified inventory-related task. The input is &lt;strong&gt;task_id&lt;/strong&gt;.
     * @param taskId The ID of the task. This ID was generated when the task was created by the &lt;strong&gt;createInventoryTask&lt;/strong&gt; method (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    private okhttp3.Call getInventoryTasksValidateBeforeCall(String feedType, String scheduleId, String lookBackDays, String dateRange, String limit, String offset, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getInventoryTasksCall(feedType, scheduleId, lookBackDays, dateRange, limit, offset, _callback);
        return localVarCall;
