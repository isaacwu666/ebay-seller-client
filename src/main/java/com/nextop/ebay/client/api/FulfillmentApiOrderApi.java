...
public class FulfillmentApiOrderApi {
    private ApiClient localVarApiClient;

    public FulfillmentApiOrderApi() {
        this(Configuration.getDefaultApiClient());
    }

    public FulfillmentApiOrderApi(ApiClient apiClient) {
     ...
     */
    public ApiResponse<Order> getOrderWithHttpInfo( @NotNull String orderId,  String fieldGroups) throws ApiException {
     ...
     */
    public ApiResponse<Refund> issueRefundWithHttpInfo( @NotNull String orderId,  IssueRefundRequest issueRefundRequest) throws ApiException {
