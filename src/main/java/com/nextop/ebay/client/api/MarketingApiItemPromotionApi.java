...
public class MarketingApiItemPromotionApi {
    private ApiClient localVarApiClient;

    public MarketingApiItemPromotionApi() {
        this(Configuration.getDefaultApiClient());
    }

    public MarketingApiItemPromotionApi(ApiClient apiClient) {
    ...
    private okhttp3.Call createItemPromotionValidateBeforeCall(ItemPromotion itemPromotion, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createItemPromotionCall(itemPromotion, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteItemPromotionValidateBeforeCall(String promotionId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteItemPromotionCall(promotionId, _callback);
        return localVarCall;
     ...
     */
    public Object deleteItemPromotion(String promotionId) throws ApiException {
        ApiResponse<Object> localVarResp = deleteItemPromotionWithHttpInfo(promotionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteItemPromotionWithHttpInfo( @NotNull String promotionId) throws ApiException {
    ...
    /**
     * /item_promotion/{promotion_id} (asynchronously)
     * This method deletes the threshold promotion specified by the &lt;b&gt;promotion_id&lt;/b&gt; path parameter. Call &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/resources/promotion/methods/getPromotions\&quot;&gt;getPromotions&lt;/a&gt; to retrieve the IDs of a seller&#39;s promotions.  &lt;br&gt;&lt;br&gt;You can delete any promotion with the exception of those that are currently active (RUNNING). To end a running threshold promotion, call &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/resources/item_promotion/methods/updateItemPromotion\&quot;&gt;updateItemPromotion&lt;/a&gt; and adjust the &lt;b&gt;endDate&lt;/b&gt; field as appropriate.
     * @param promotionId This path parameter takes a concatenation of the ID of the promotion you want to delete plus the marketplace ID on which the promotion is hosted. Concatenate the two values by separating them with an \&quot;at sign\&quot; (&lt;b&gt;@&lt;/b&gt;).  &lt;br&gt;&lt;br&gt;The ID of the promotion (&lt;b&gt;promotionId&lt;/b&gt;) is a unique eBay-assigned value that&#39;s generated when the promotion is created. The Marketplace ID is the ENUM value of eBay marketplace where the promotion is hosted. &lt;br&gt;&lt;br&gt;&lt;b&gt;Example:&lt;/b&gt; &lt;code&gt;1********5@EBAY_US&lt;/code&gt; (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteItemPromotionAsync(String promotionId, final ApiCallback<Object> _callback) throws ApiException {
    ...
    private okhttp3.Call getItemPromotionValidateBeforeCall(String promotionId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getItemPromotionCall(promotionId, _callback);
        return localVarCall;
     ...
     */
    public ApiResponse<ItemPromotionResponse> getItemPromotionWithHttpInfo( @NotNull String promotionId) throws ApiException {
    ...
    private okhttp3.Call updateItemPromotionValidateBeforeCall(String promotionId, ItemPromotion itemPromotion, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateItemPromotionCall(promotionId, itemPromotion, _callback);
        return localVarCall;
     ...
     */
    public ApiResponse<BaseResponse> updateItemPromotionWithHttpInfo( @NotNull String promotionId,  ItemPromotion itemPromotion) throws ApiException {
