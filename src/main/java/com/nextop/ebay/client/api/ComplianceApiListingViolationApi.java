...
import com.nextop.ebay.client.model.SuppressViolationRequest;
...
public class ComplianceApiListingViolationApi {
    private ApiClient localVarApiClient;

    public ComplianceApiListingViolationApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ComplianceApiListingViolationApi(ApiClient apiClient) {
    ...
    private okhttp3.Call getListingViolationsValidateBeforeCall(String X_EBAY_C_MARKETPLACE_ID, String complianceType, String offset, String listingId, String limit, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getListingViolationsCall(X_EBAY_C_MARKETPLACE_ID, complianceType, offset, listingId, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public Object getListingViolations(String X_EBAY_C_MARKETPLACE_ID, String complianceType, String offset, String listingId, String limit, String filter) throws ApiException {
        ApiResponse<Object> localVarResp = getListingViolationsWithHttpInfo(X_EBAY_C_MARKETPLACE_ID, complianceType, offset, listingId, limit, filter);
     ...
     */
    public ApiResponse<Object> getListingViolationsWithHttpInfo( @NotNull String X_EBAY_C_MARKETPLACE_ID,  String complianceType,  String offset,  String listingId,  String limit,  String filter) throws ApiException {
    ...
    /**
     * /listing_violation (asynchronously)
     * This call returns specific listing violations for the supported listing compliance types. Only one compliance type can be passed in per call, and the response will include all the listing violations for this compliance type, and listing violations are grouped together by eBay listing ID. See ComplianceTypeEnum for more information on the supported listing compliance types. This method also has pagination control. Note: A maximum of 2000 listing violations will be returned in a result set. If the seller has more than 2000 listing violations, some/all of those listing violations must be corrected before additional listing violations will be retrieved. The user should pay attention to the total value in the response. If this value is &#39;2000&#39;, it is possible that the seller has more than 2000 listing violations, but this field maxes out at 2000. Note: In a future release of this API, the seller will be able to pass in a specific eBay listing ID as a query parameter to see if this specific listing has any violations. Note: Only mocked non-compliant listing data will be returned for this call in the Sandbox environment, and not specific to the seller. However, the user can still use this mock data to experiment with the compliance type filters and pagination control.
     * @param X_EBAY_C_MARKETPLACE_ID This header is required and is used to specify the eBay marketplace identifier. Supported values for this header can be found in the MarketplaceIdEnum type definition. Note that Version 1.4.0 of the Compliance API is only supported on the US, UK, Australia, Canada {English), and Germany sites. (required)
     * @param complianceType A seller uses this query parameter to retrieve listing violations of a specific compliance type. Only one compliance type value should be passed in here. See ComplianceTypeEnum for more information on the compliance types that can be passed in here. If the listing_id query parameter is used, the compliance_type query parameter {if passed in) will be ignored. This is because all of a listing&#39;s policy violations {each compliance type) will be returned if a listing_id is provided. Either the listing_id or a compliance_type query parameter must be used, and if the seller only wants to view listing violations of a specific compliance type, both of these parameters can be used. Note: The listing_id query parameter is not yet available for use, so the seller does not have the ability to retrieve listing violations for one or more specific listings. Until the listing_id query parameter becomes available, the compliance_type query parameter is required with each getListingViolations call. (optional)
     * @param offset The integer value input into this field controls the first listing violation in the result set that will be displayed at the top of the response. The offset and limit query parameters are used to control the pagination of the output. For example, if offset is set to 10 and limit is set to 10, the call retrieves listing violations 11 thru 20 from the resulting set of violations. Note: This feature employs a zero-based index, where the first item in the list has an offset of 0. If the listing_id parameter is included in the request, this parameter will be ignored. Default: 0 {zero) (optional)
     ...
     */
    public okhttp3.Call getListingViolationsAsync(String X_EBAY_C_MARKETPLACE_ID, String complianceType, String offset, String listingId, String limit, String filter, final ApiCallback<Object> _callback) throws ApiException {
     ...
     * @param suppressViolationRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    private okhttp3.Call suppressViolationValidateBeforeCall(SuppressViolationRequest suppressViolationRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = suppressViolationCall(suppressViolationRequest, _callback);
        return localVarCall;
     ...
     */
    public Object suppressViolation(SuppressViolationRequest suppressViolationRequest) throws ApiException {
        ApiResponse<Object> localVarResp = suppressViolationWithHttpInfo(suppressViolationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> suppressViolationWithHttpInfo( SuppressViolationRequest suppressViolationRequest) throws ApiException {
    ...
    /**
     * /suppress_listing_violation (asynchronously)
     * This call suppresses a listing violation for a specific listing. Only listing violations in the AT_RISK state (returned in the violations.complianceState field of the getListingViolations call) can be suppressed. Note: At this time, the suppressViolation call only supports the suppressing of ASPECTS_ADOPTION listing violations in the AT_RISK state. In the future, it is possible that this method can be used to suppress other listing violation types. A successful call returns a http status code of 204 Success. There is no response payload. If the call is not successful, an error code will be returned stating the issue.
     * @param suppressViolationRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call suppressViolationAsync(SuppressViolationRequest suppressViolationRequest, final ApiCallback<Object> _callback) throws ApiException {
